...
const base = 'https://syofyanzuhad.dev'
const tweetUrl = computed(() => `https://twitter.com/intent/tweet?text=${encodeURIComponent(`Reading @syofyan_zuhad\'s ${base}${route.path}\n\nI think...`)}`)
