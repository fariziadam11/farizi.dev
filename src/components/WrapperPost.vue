...
const base = 'https://fariziadamdev.netlify.app'
const tweetUrl = computed(() => `https://twitter.com/intent/tweet?text=${encodeURIComponent(`Reading @fariziadam508\'s ${base}${route.path}\n\nI think...`)}`)
const elkUrl = computed(() => `https://elk.zone/intent/post?text=${encodeURIComponent(`Reading @fariziadam508@m.webtoo.ls\'s ${base}${route.path}\n\nI think...`)}`)
const blueskyUrl = computed(() => `https://bsky.app/intent/compose?text=${encodeURIComponent(`Reading @fariziadam508.me ${base}${route.path}\n\nI think...`)}`)
